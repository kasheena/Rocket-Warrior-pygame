...
def check_keydown_events(event, screen, ship, aliens, bullets):
...
#to maint user actions
    for event in pygame.event.get():
            if event.type == pygame.QUIT:
                sys.exit()
            
            elif event.type == pygame.KEYDOWN:
                check_keydown_events(event, screen, ship, aliens, bullets)
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    bullets.update()
    #Get rid of bullets taht have disappeared s
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):            
    #checking bullets hitting aliens
